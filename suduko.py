# -*- coding: utf-8 -*-
"""
Created on Thu Nov 02 15:39:38 2017
...
def print_grid3(arr):
    return int(str(arr[0][0]) + str(arr[0][1]) + str(arr[0][2]))
...
if __name__=="__main__":
    ...
    print sum((print_grid3(a_grid[i]) for i in a_grid if(solve_sudoku(a_grid[i]))))
